...
echo.
echo   Compte administrateur (VERSION PRODUCTION) :
echo     ╔══════════════════════════════════════════════════════════╗
...
echo     ╚══════════════════════════════════════════════════════════╝
echo.
echo   IMPORTANT : Changer ce mot de passe IMMÉDIATEMENT après
echo   la première connexion !
echo.
echo   Objectifs 3-3-3 pré-configurés :
echo     🔵 Production              : 70%%
echo     🟡 Administration ^& Report : 20%%
echo     🟢 Contrôle                : 10%%
echo.
echo   Créez les autres comptes via l'interface admin.
echo.
pause
